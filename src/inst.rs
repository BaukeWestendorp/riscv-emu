...
impl std::fmt::Debug for Instruction {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        ...
        match kind {
            I::Lui     => write!(f, "lui   rd=x{}, imm={:#x?}", self.rd(), self.imm_u()),
            I::Auipc   => write!(f, "auipc rd=x{}, imm={:#x?}", self.rd(), self.imm_u()),
            I::Jal     => write!(f, "jal   rd=x{}, imm={:x?}", self.rd(), self.imm_j()),
            I::Beq     => write!(f, "beq   rs1=x{}, rs2=x{}, imm={:x?}", self.rs1(), self.rs2(), self.imm_b()),
            I::Bne     => write!(f, "bne   rs1=x{}, rs2=x{}, imm={:x?}", self.rs1(), self.rs2(), self.imm_b()),
            I::Blt     => write!(f, "blt   rs1=x{}, rs2=x{}, imm={:x?}", self.rs1(), self.rs2(), self.imm_b()),
            I::Bge     => write!(f, "bge   rs1=x{}, rs2=x{}, imm={:x?}", self.rs1(), self.rs2(), self.imm_b()),
            I::Bltu    => write!(f, "bltu  rs1=x{}, rs2=x{}, imm={:x?}", self.rs1(), self.rs2(), self.imm_b()),
            I::Bgeu    => write!(f, "bgeu  rs1=x{}, rs2=x{}, imm={:x?}", self.rs1(), self.rs2(), self.imm_b()),
            I::Jalr    => write!(f, "jalr  rd=x{}, imm=${:3x?}(rs1=x{})", self.rd(), self.imm_i(), self.rs1()),
            I::Lb      => write!(f, "lb    rd=x{}, imm=${:3x?}(rs1=x{})", self.rd(), self.imm_i(), self.rs1()),
            I::Lh      => write!(f, "lh    rd=x{}, imm=${:3x?}(rs1=x{})", self.rd(), self.imm_i(), self.rs1()),
            I::Lw      => write!(f, "lw    rd=x{}, imm=${:3x?}(rs1=x{})", self.rd(), self.imm_i(), self.rs1()),
            I::Lbu     => write!(f, "lbu   rd=x{}, imm=${:3x?}(rs1=x{})", self.rd(), self.imm_i(), self.rs1()),
            I::Lhu     => write!(f, "lhu   rd=x{}, imm=${:3x?}(rs1=x{})", self.rd(), self.imm_i(), self.rs1()),
            I::Addi    => write!(f, "addi  rd=x{}, rs1=x{}, imm={:#x?}", self.rd(), self.rs1(), self.imm_i()),
            I::Slti    => write!(f, "slti  rd=x{}, rs1=x{}, imm={:#x?}", self.rd(), self.rs1(), self.imm_i()),
            I::Sltiu   => write!(f, "sltiu rd=x{}, rs1=x{}, imm={:#x?}", self.rd(), self.rs1(), self.imm_i()),
            I::Xori    => write!(f, "xori  rd=x{}, rs1=x{}, imm={:#x?}", self.rd(), self.rs1(), self.imm_i()),
            I::Ori     => write!(f, "ori   rd=x{}, rs1=x{}, imm={:#x?}", self.rd(), self.rs1(), self.imm_i()),
            I::Andi    => write!(f, "andi  rd=x{}, rs1=x{}, imm={:#x?}", self.rd(), self.rs1(), self.imm_i()),
            I::Sb      => write!(f, "sb    rs2=x{}, imm=${:3x?}(rs1=x{})", self.rs2(), self.imm_s(), self.rs1()),
            I::Sh      => write!(f, "sh    rs2=x{}, imm=${:3x?}(rs1=x{})", self.rs2(), self.imm_s(), self.rs1()),
            I::Sw      => write!(f, "sw    rs2=x{}, imm=${:3x?}(rs1=x{})", self.rs2(), self.imm_s(), self.rs1()),
            I::Slli    => write!(f, "slli  rd=x{}, rs1=x{}, shamt={}", self.rd(), self.rs1(), self.imm_i()),
            I::Srli    => write!(f, "srli  rd=x{}, rs1=x{}, shamt={}", self.rd(), self.rs1(), self.imm_i()),
            I::Srai    => write!(f, "srai  rd=x{}, rs1=x{}, shamt={}", self.rd(), self.rs1(), self.imm_i()),
            I::Add     => write!(f, "add   rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::Sub     => write!(f, "sub   rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::Sll     => write!(f, "sll   rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::Slt     => write!(f, "slt   rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::Sltu    => write!(f, "sltu  rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::Xor     => write!(f, "xor   rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::Srl     => write!(f, "srl   rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::Sra     => write!(f, "sra   rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::Or      => write!(f, "or    rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
            I::And     => write!(f, "and   rd=x{}, rs1=x{}, sr2=x{}",  self.rd(), self.rs1(), self.rs2()),
